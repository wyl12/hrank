...
if args.dataset=='cifar10':
    ...
    train_dataset = my_Data_Set('/home/lsw/LSW/2023/HRank-master/data/Traindata/train.txt', transform=data_transforms['train'], loader=Load_Image_Information)
    test_dataset = my_Data_Set('/home/lsw/LSW/2023/HRank-master/data/Traindata/train.txt', transform=data_transforms['val'], loader=Load_Image_Information)
